...
sys.path.insert(1, os.path.join(root_folder, 'apple_watch/tools/'))
sys.path.insert(1, os.path.join(root_folder, 'stress_analysis/tools/'))
sys.path.insert(1, os.path.join(root_folder, 'ieeg_hr/'))
...
username = 'jalpanchal'
pwd_bin_path = root_folder+"tools/jal_ieeglogin.bin"
